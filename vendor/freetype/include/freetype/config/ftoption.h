...
#define FT_CONFIG_OPTION_USE_LZW
   ...
   *
   *   natyv: disabled -- this is also what gates WOFF decompression
   *   (src/sfnt/sfwoff.c, guarded by this same macro), which natyv doesn't
   *   need since it only loads plain uncompressed TTF/OTF files. Disabling
   *   it means natyv has zero zlib dependency, on any platform.
   */
